...
export const VelinCalendar = createVelinComponent('velin-calendar');
...
export const VelinEmptyState = createVelinComponent('velin-empty-state');
export const VelinFileDropzone = createVelinComponent('velin-file-dropzone');
...
export const VelinOtpInput = createVelinComponent('velin-otp-input');
export const VelinPasswordStrength = createVelinComponent('velin-password-strength');
