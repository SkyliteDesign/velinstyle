---
name: velin-migration-prefix-classes
description: Migrates class names to velin-* convention.
---

# Migration Prefix Classes

## Goal
Deliver migration prefix classes outcomes with VelinStyle constraints.
...
## Examples
- Prompt example: "Run velin-migration-prefix-classes for this page."
