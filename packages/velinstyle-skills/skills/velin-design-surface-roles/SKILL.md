...
## Goal
Deliver surface roles outcomes with VelinStyle constraints.

## Description
Use this skill when capability targets include: build, theme.
...
## Examples
- Prompt example: "Run velin-design-surface-roles for this page."
