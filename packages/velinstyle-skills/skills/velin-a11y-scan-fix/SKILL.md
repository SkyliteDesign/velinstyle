...
description: Uses scanner output to fix high-confidence accessibility issues.
---

# A11y Scan Fix

## Goal
Deliver a11y scan fix outcomes with VelinStyle constraints.
...
## Examples
- Prompt example: "Run velin-a11y-scan-fix for this page."
