---
name: velin-a11y-page-checklist
description: Runs page-level accessibility checklist before release.
---

# A11y Page Checklist

## Goal
Deliver a11y page checklist outcomes with VelinStyle constraints.

## Description
Use this skill when capability targets include: accessibility, review.
...
4. Emit outputs: checklist, report.
...
## Examples
- Prompt example: "Run velin-a11y-page-checklist for this page."
...
## Output Format
- Primary outputs: checklist, report.
