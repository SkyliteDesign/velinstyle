---
name: velin-dx-doctor-setup
description: Runs setup diagnostics and proposes fixes for dev experience gaps.
---

# DX Doctor Setup

## Goal
Deliver dx doctor setup outcomes with VelinStyle constraints.

## Description
Use this skill when capability targets include: dx, review.

## Prerequisites
- Framework compatibility: 1.2.0 to 2.x
- CLI: scan
- Dependencies: velin-dx-project-init
...
## Examples
- Prompt example: "Run velin-dx-doctor-setup for this page."
